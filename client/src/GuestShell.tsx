 ...
 * read at leisure, whole conversations at a time. Nothing private is
 * mounted — no whisper sidebar, no mailbox, no addresses — and no private
 * route is ever called. Reading is keyless; writing is a resident act.
 */
